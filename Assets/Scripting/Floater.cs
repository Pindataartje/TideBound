...
public class Floater : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Remove rotation freeze so we can apply slight rotation changes.
    ...
    void FixedUpdate()
    {
        ...
        if (adjustRotation)
        {
            ...
            float targetRoll = maxRoll * Mathf.Sin(2 * Mathf.PI * baseFrequency * t + phaseOffset + Mathf.PI / 2); // offset for variation
